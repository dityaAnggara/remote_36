			...
			%for o in objects:
				...
				<table class="main" cellspacing="0">
					...
					%for invoice_line in [line for line in o.invoice_line]:
						%if invoice_line.product_id.type != 'service':
							<tr class='inv_line'>
								...
								<td>${formatLang(int((invoice_line.price_subtotal)) or "",digits=get_digits(dp='Faktur'))}</td>
					...
					<tr>
						...
						<td>${formatLang(int(tot),digits=get_digits(dp='Faktur'))}</td>
					...
					<tr>
						...
						<td>${formatLang(int(tot_tax),digits=get_digits(dp='Faktur'))}</td>
							...
							<table width="100%" border="0px" cellspacing='0'>
								...
								<tr>
									...
									<td rowspan="2" width="30%" style="text-align:left; border: 0;">
										<span style="border-bottom: 1px solid;">Nama : Irawati Gardjito</span>
										<p style="margin-top: 0;">Jabatan : Director</p>
									</td>
								</tr>
								<tr>
